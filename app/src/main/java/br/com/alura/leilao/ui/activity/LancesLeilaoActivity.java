...
public class LancesLeilaoActivity extends AppCompatActivity {
    ...
    private void adicionaMaioresLances(Leilao leilao) {
        ...
        for (Lance lance :
            ...
            sb.append(formatador.transformaEmReal(lance.getValor()))
                    .append(" - ")
    ...
    private void adicionaMenorLance(Leilao leilao) {
        menorLance.setText(formatador.transformaEmReal(leilao.getMenorLance()));
    }

    private void adicionaMaiorLance(Leilao leilao) {
        maiorLance.setText(formatador.transformaEmReal(leilao.getMaiorLance()));
    }
